    ...
    return (
        <div className="flex-1">
            <div className=" bg-black flex justify-center">
                <div className="h-full w-full maz-w[1100px] max-h-[68vh] aspect-video">
                    <Player>
            ...
            <div className="p-8 max-[1100px] mx-auto">
                <div className="flex itens-start gp-16">
                    <div className="flex-1">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <a href="" className="p-4 text-sm flex itens-center rounded font-bold uppercase gap-2 justify-center border border-blue-500 text=blue-500 hover:bg-blue-50 hover:text-gray-900 transition-colors">
                            <Lightning size={24}/>
                            Acesse o desafio
                        </a>
                    </div>
